...
export const unitsToUnits = (a: string): [string] => {
  var result;
  switch (a) {
    case "milligram":
      result = unitsSolid;
...
export const UpdateProductDialog = ({
  ...
  const {
    ...
    id: id,
    onCompleted: (result) =>
      setSuppliers(mapToSupplierToQ(result.product.suppliers)),
  });
            ...
            <>
              ...
              <DialogContent>
                <Grid container xs={12} spacing={2}>
                  ...
                  <Grid xs={3}>
                    <H5 title="Merknaam" />
                    <FormField name="input.brand" label="Merk" />
                  </Grid>
                  <Grid xs={1}></Grid>
                  <Grid xs={3}>
                    <H5 title="Land van herkomst" />
                    <FormField name="input.origin" label="Herkomst" />
                  </Grid>
                  <Grid xs={1}></Grid>
                  <Grid xs={7}>
                    {/* <H5 title="Prijs (€)"/> */}
                    <PriceInput units={unitsToUnits(values.input.unit)} />
                    {/* <Price 
                    ...
                    <Grid xs={12}>
                      <TableSupplierData
                        setSuppliers={(selected) =>
                          setSuppliers([...selectedSuppliers, selected])
                        }
                      />
                    </Grid>
                  </Grid>
