        ...
        <TableRow>
          <TableCell align="center" colSpan={5}>
            <Button variant="outlined" onClick={() => setOpenAdd(true)}>
              Ingredienten toevoegen aan inventaris
            </Button>
          </TableCell>
        </TableRow>
      </Table>
...
const Row = ({
  ...
  data: listInventory_listInventory;
          ...
          <>
            <TableRow>
              ...
              <TableCell align="left">
                {data.quantity.quantity} {data.quantity.unit}
              </TableCell>
              <TableCell align="left">€{data.price.toFixed(2)}</TableCell>
              <TableCell>
                <TableCell align="left">{values.number}</TableCell>
                {/* <FormFieldEdit 
              placeholder="1"
              name="number"
              label=""
