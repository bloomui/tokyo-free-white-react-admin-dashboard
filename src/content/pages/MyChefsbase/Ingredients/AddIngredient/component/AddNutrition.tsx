...
export const InsertNutrition = ({
  ...
  <TableContainer>
                  ...
                  />
                              ...
                              <TextField
                              select
                              onChange={(e) => setFieldValue("input.nutrition.unit", e.target.value)}
                        >
                {units.map((unit) => (
                  <MenuItem key={unit} value={unit}>{unit}</MenuItem>
                        ...
                        <TableCell>
                          ...
                          fullWidth
                          placeholder={"0"}
                          onChange={(e) => setFieldValue("input.nutrition.nutrition.kcal", Number(e.target.value))}
                          />
                  </TableCell>
                        ...
                        <TextField
                          fullWidth
                          placeholder={"0"}
                          onChange={(e) => setFieldValue("input.nutrition.nutrition.prottotal", Number(e.target.value))}
                          /></TableCell>
                        <TableCell>Koolhydraten</TableCell>
                        <TableCell><TextField
                          fullWidth
                          placeholder={"0"}
                          onChange={(e) => setFieldValue("input.nutrition.nutrition.carbscarbs", Number(e.target.value))}
                          /></TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TextField
                          fullWidth
                          placeholder={"0"}
                          onChange={(e) => setFieldValue("input.nutrition.nutrition.carbssugar", Number(e.target.value))}
                          /></TableCell>
                        ...
                        <TextField
                          fullWidth
                          placeholder={"0"}
                          onChange={(e) => setFieldValue("input.nutrition.nutrition.fatstotal", Number(e.target.value))}
                          /></TableCell>
                        <TableCell>Vezels</TableCell>
                        <TableCell><TextField
                          fullWidth
                          placeholder={"0"}
                          onChange={(e) => setFieldValue("input.nutrition.nutrition.fibres", Number(e.target.value))}
                          /></TableCell>
                      </TableRow>
                      </Table>
                      </TableContainer>
