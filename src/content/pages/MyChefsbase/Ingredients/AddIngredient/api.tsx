...
} from "./types/AddQuickProducts";
import { products } from "./types/products";
import {
  searchIngredient,
  searchIngredientVariables,
} from "./types/searchIngredient";
...
export const useSearchIngredientFilterQuery = ({ name }: { name: string }) => {
...
export const useSearchProductQuery = ({
  ...
  const { loading, data, error, refetch } = useSimpleQuery<products>(
    productsQuery,
    {
      variables: {
        input: name,
